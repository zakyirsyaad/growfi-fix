  ...
  if (status === "loading") {
    return (
      <div className="min-h-screen bg-background flex items-center justify-center p-4">
        <Card className="max-w-md w-full p-8 flex flex-col items-center justify-center space-y-4 border border-border shadow-2xl bg-card rounded-2xl">
  ...
  if (status !== "authenticated") {
    return (
      <div className="min-h-screen bg-background flex items-center justify-center p-4 relative overflow-hidden">
        ...
        <div className="absolute bottom-[-10%] right-[-10%] w-[600px] h-[600px] opacity-20 bg-gold-300/30 rounded-full blur-[100px] pointer-events-none" />

        <Card className="relative z-10 max-w-md w-full border border-border/60 shadow-2xl bg-card/80 backdrop-blur-xl rounded-2xl overflow-hidden">
          <div className="absolute top-0 right-0 w-32 h-32 bg-primary/5 rounded-bl-[3rem] -z-10" />
